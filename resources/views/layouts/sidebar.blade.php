    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('admin.faq.*') ? 'active' : '' }}" href="{{ route('admin.courier.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('admin.shipping_province.*') ? 'active' : '' }}" href="{{ route('admin.shipping_province.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="feather feather-shopping-cart">
                            <circle cx="9" cy="21" r="1"></circle>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('admin.report.*') ? 'active' : '' }}" href="{{ route('admin.report.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <line x  1="6" y1="20" x2="6" y2="14"></line>
                        </svg>
                        Reports
                    </a>
                </li>
